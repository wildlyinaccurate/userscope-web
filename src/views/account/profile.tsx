...
const ProfileView = (props: ProfileViewProps) => (
  <MainLayout {...props}>
    ...
    <form action="/account/profile" method="POST" className="form-horizontal">
      ...
      <div className="form-group row justify-content-md-center">
        <label htmlFor="name" className="col-sm-3 col-form-label text-right font-weight-bold">Name</label>
        <div className="col-sm-7">
      ...
      <div className="form-group row justify-content-md-center">
        ...
        <div className="col-sm-7">
          <img src={props.user.gravatar(100)} width="100" height="100" alt={props.user.displayName} className="profile" />
        </div>
      </div>
      <div className="form-group row justify-content-md-center">
        <div className="col-sm-4">
          <button type="submit" className="btn btn btn-primary">Update profile</button>
        </div>
      </div>
    </form>
    <div className="page-header">
    ...
    <form action="/account/password" method="POST" className="form-horizontal">
      <input type="hidden" name="_csrf" value={props._csrf} />
      <div className="form-group row justify-content-md-center">
        <label htmlFor="password" className="col-sm-3 col-form-label text-right font-weight-bold">New password</label>
        <div className="col-sm-7">
    ...
    <form action="/account/delete" method="POST" className="form-horizontal">
      <div className="form-group row justify-content-md-center">
        <p className="offset-sm-3 col-sm-7">You can delete your account, but keep in mind this action is irreversible.</p>
        <input type="hidden" name="_csrf" value={props._csrf} />
        <div className="col-sm-4">
